...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.dconv_up3 = self.double_conv(512, 256)
        self.dconv_up4 = self.double_conv(256, 256)

        self.upconv3 = nn.ConvTranspose2d(256, 128, 2, 2, padding = 0)

        self.dconv_up5 = self.double_conv(256, 128)
        self.dconv_up6 = self.double_conv(128, 128)

        self.upconv4 = nn.ConvTranspose2d(128, 64, 2, 2, padding = 0    )

        self.dconv_up7 = self.double_conv(128, 64)
        self.dconv_up8 = self.double_conv(64, 64)
